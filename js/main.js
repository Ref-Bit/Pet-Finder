...
const key = "vh5JDfCFcio6cagC6gGlJjWp4iK3RkhSYvkCQOPHgde7IEoH1g";
const secretKey = "Ii6zQF3lavjUZP78upvrxavYrM6KCSiYMkwdwPcp";
const validZip = /^\d{5}$/;
...
function updateUI(animalInfo) {
  ...
  animalInfo.forEach(animal => {
    ...
    if (animal.photos.length > 0) {
      ...
      image = `https://source.unsplash.com/600x600/?animals,${animal.type}`;
    }
    results.innerHTML += `
      <div class="card flex-row">
        <img src=${image} class="w-25" alt='${animal.type}-Picture'>
        <div class="card-body">
